package com.michng.cineapp.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.michng.cineapp.service.EmailAlreadyUsedException ||
            ex instanceof com.michng.cineapp.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.michng.cineapp.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.michng.cineapp");
    }
}
